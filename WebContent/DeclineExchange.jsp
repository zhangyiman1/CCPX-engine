...
<body>
<form method="post" action="declineExchange" id="declineExchange">
						<h2>Decline Exchange</h2>
						<ul class="form-list">
							<li>
							...
							<li>
								<label class="required" for="pass">user to<em>*</em></label>
								<div class="input-box">
									<input type="text" name="user_to"
					maxlength="16" id="user_to" tabindex="2" class="input-text required-entry validate-password"/>
